...
Namely, popular QTL mapping methods (such as R/qtl2 [@PMID:]) use linear models to discover associations between genotypes and phenotypes, enabling the inclusion of additive and interactive covariates, as well as kinship matrices, in QTL scans.
