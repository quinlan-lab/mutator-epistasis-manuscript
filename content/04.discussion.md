...
DBA/2J (*D*) alleles at this locus had no detectable effect on C>A mutation rates in mice that also harbored "wild-type" C57BL/6J (*B*) alleles at a previously discovered mutator locus on chromosome 4 [@PMID:35545679]; moreover, mice with *D* alleles at both loci had even higher mutation rates that those with *D* alleles at either locus alone (Figure @fig:spectra-comparison). 
...
We have not conclusively fine-mapped the chromosome 6 mutator locus to a causal variant, but we believe that a nonsynonymous mutation in the DNA glycosylase *Mbd4*, which was not observed in wild mouse populations, is the best candidate. 
...
### *Mbd4* may influence the effects of *Mutyh* loss-of-function by regulating apoptosis
...
Bi-allelic loss-of-function (LOF) mutations in human *MBD4* underlie a neoplastic syndrome that closely mimics forms of familial adenomatous polyposis caused by LOF mutations in *MUTYH* [@PMID:35460607]. 
...
If those germ cells harbor wild-type copies of *Mbd4*, they might be able to trigger apoptosis and mitigate the effects of a *Mutyh* mutator allele; however, mice with loss-of-function mutations in both *Mbd4* and *Mutyh* would accumulate even higher levels of germline DNA damage, leading to substantially elevated germline C>A mutation rates. 
...
Using long-read assemblies of several inbred laboratory mouse strains, however, another group revealed that this previous mutator phenotype may be caused by a ~5 kbp mobile element insertion (MEI) within the first intron of *Mutyh* [@doi:10.1016/j.xgen.2023.100291], which is associated with significantly reduced expression of *Mutyh* in embryonic stem cells.
We queried these high-quality assemblies for evidence of mobile elements or other large structural variants (SVs) in the region surrounding the mutator locus on chromosome 6, but found no similarly compelling evidence that either SVs or MEIs might underlie the new mutator phenotype described in this study. 
