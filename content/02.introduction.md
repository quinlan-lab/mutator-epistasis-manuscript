...
The germline mutation rate reflects the complex interplay between DNA replication and repair pathways, exogenous sources of DNA damage, and life-history traits. 
...
Nonetheless, genetic variants that increase germline mutation rates, known as *mutator alleles*, have largely eluded detection in mammals.
...
In our previous study, whole-genome sequencing data from the BXD strains were used to map a quantitative trait locus (QTL) for the C>A mutation rate [@PMID:35545679].
